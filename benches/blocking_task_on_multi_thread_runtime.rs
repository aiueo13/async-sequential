...
fn sequential_executor_on_muilti_thread_runtime(c: &mut Criterion) {
    blocking_task_with_sequential_executor(c, multi_rt(), "blocking_task_with_sequential_executor_on_multi_thread_runtime");
}

fn tokio_spawn_mutex_on_muilti_thread_runtime(c: &mut Criterion) {
    blocking_task_with_tokio_spawn_mutex(c, multi_rt(), "blocking_task_with_tokio_spawn_mutex_on_multi_thread_runtime");
}
